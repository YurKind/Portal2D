...
namespace game
{
	...
	void turretPatrol(GameInfo* gameInfo, MapCell** map, bool heroIsSpotted, bool *isMovingRight, bool *isWallHere);
	...
	void shootingToHeroPatrol(GameInfo* gameInfo, MapCell** map, bool heroIsSpotted, bool *isWallHere);
	void shootingToRight(GameInfo* gameInfo, MapCell** map);
	void shootingToLeft(GameInfo* gameInfo, MapCell** map);
