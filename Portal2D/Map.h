...
namespace game
{
	...
	{
		Hero hero;
		Objects redPortal, bluePortal, aim, blackWall, exitFromLevel, button, turret, stationary_turret, platform_turret, bulletOfStationaryTurret, bulletOfPlatformTurret;
	};
